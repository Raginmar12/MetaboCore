...
La fuente oficial en Markdown se agregará manualmente en una fase posterior dentro de `docs/03_capa_nom/nom_004/fuente_oficial/`.
...
La carpeta `fuente_oficial/` quedará preparada para recibir manualmente el texto oficial convertido a Markdown.
...
- El texto completo de la norma no será copiado automáticamente por agentes; se agregará manualmente como fuente oficial.
